...
class Article(models.Model):
    ...
    WIDGETS = {
        ...
        '{twitter}': '<a class="twitter-timeline" href="https://twitter.com/BrainchildFest" data-widget-id="571117174111363072">Tweets by @BrainchildFest</a><script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?"http":"https";if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>',
    }
